...
const paths = [
  ...
  { id: 'project', label: 'Project catalog', title: 'Commit the choices with the project.', text: 'Import the default Atlas catalog through shadcn, then preview project-local setup. Distribution and setup ownership stay explicit.', command: 'pnpm dlx shadcn@latest add logbookfordevs/logbook-atlas/afk-catalog\nafk setup --local --dry-run', facts: ['Repo-local catalog', 'Reviewable defaults', 'Explicit ownership'] },
];
const pieces = [
