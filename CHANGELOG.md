...
- `cli:` added `afk refresh --override` to replace targeted catalog files from the selected remote source after two explicit confirmations, with dry-run preview support.
