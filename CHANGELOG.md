...
- `skills:` rebuilt Animated-Driven Frontend as a co-directed cinematic production workflow with human greenlights for treatment, shot planning, tracer dailies, production batches, and final cut, while preserving its ZERO-derived narrative and rendering engineering.
