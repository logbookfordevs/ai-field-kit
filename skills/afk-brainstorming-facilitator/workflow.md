...
- `brainstorming_session_output_file` = set this according to the repo or user artifact convention. If none exists, follow the AFK default from `afk-artifact-workflow`.
