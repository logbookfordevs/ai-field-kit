...
- `brainstorming_session_output_file` = set this according to the repo or user artifact convention. If none exists, follow the AFK artifact convention from `afk-compass/references/artifacts.md`.
