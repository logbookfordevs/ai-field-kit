...
Keep some of the session's creative spark alive during synthesis:
- name themes in memorable ways when helpful
- preserve surprising breakthroughs rather than smoothing them away
- note rejected or wild ideas if they reveal an important pattern
...
- they explored widely
- they discovered something non-obvious
- the session produced usable outcomes
- the creativity was preserved, not merely compressed
