...
When writing a file, follow the repo or user artifact convention. If none exists, follow the AFK artifact convention from `afk-compass/references/artifacts.md`.
