---
name: codex-uncodexfy
description: Avoid generic AI-generated UI aesthetics and push interfaces toward restrained, human-designed patterns. Use when designing or reviewing frontend UI that risks default Codex-style gradients, floating panels, pill overload, dashboard hero blocks, or other templated SaaS visuals.
metadata:
  short-description: Avoid generic AI UI patterns
---
