...
5. Stop at the launch boundary and ask for an explicit user trigger before execution starts.
6. After the user triggers launch, run GoalBuddy from that goal package.
7. Start or register the local board before execution and include a clickable board URL when available.
