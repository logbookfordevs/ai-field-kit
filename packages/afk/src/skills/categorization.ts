...
export function buildCategorizationPrompt(
  ...
  return [
    ...
    `- If ${skillCatalogFileName} exists and is valid, preserve install fields on every item: id, label, source, args, default, invocation, startDisabled, role, and composes.`,
