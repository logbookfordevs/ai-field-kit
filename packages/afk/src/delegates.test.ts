...
const defaultHomeDir = localHomeWithManifests({
  "skills.json": {
    version: 1,
    defaultSource: "https://github.com/logbookfordevs/logbook-atlas",
    items: [
      {
        id: "afk-note",
        label: "AFK / Note",
        source: "https://github.com/logbookfordevs/logbook-atlas",
...
test("buildSkillCommands uses the official skills CLI", () => {
  ...
  assert.deepEqual(commands[0]?.args.slice(0, 3), ["skills", "add", "https://github.com/logbookfordevs/logbook-atlas"]);
