...
See [Atlas’s tool catalog](https://github.com/logbookfordevs/logbook-atlas/blob/main/afk/catalog/tools.json) for current recommendations. Tool setup is
...
afk skills add logbookfordevs/logbook-atlas --skill hyperframes --yes --profile video
afk skills add logbookfordevs/logbook-atlas --skill hyperframes --yes --profile-only video
afk skills add logbookfordevs/logbook-atlas --skill hyperframes --yes --start-disabled
...
afk skills invocation manual writing-for-humans --dry-run
